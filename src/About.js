...
function About() {
  return (
    <section className="container m-auto bg-cover bg-center bg-no-repeat px-[20px] md:px-0" id="about" >
    <div className="About mb-10 md:mb-0 lg:h-[100vh] relative ">
      ...
      <div className='md:w-1/2 text-sm md:text-lg montserrat-regular flex flex-col gap-2 justify-center'>
      <h1 className='text-5xl md:text-7xl montserrat-bold mb-10 tracking-tighter md:tracking-normal'><span className="block sm:inline text-center md:text-left">About me</span></h1>
    ...
    <div className="About mb-10 md:mb-0 lg:h-[100vh] relative">
      ...
      <div className='flex flex-col-reverse md:flex-row md:gap-10 h-full justify-center'>
