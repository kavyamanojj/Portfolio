  ...
  return (
    <div className="flex justify-center item-center fixed top-3 w-full z-50">
      <nav className="flex gap-1 p-0.5 border border-black/50 rounded-xl bg-white/10 backdrop-blur montserrat-regular">
        ...
        <a href="https://drive.google.com/file/d/11dOjXYPGAVRZXlQJiCH4fGDdQ1ZcGJrM/view?usp=sharing" target="_blank" rel="noreferrer" className="nav-item bg-black text-white/90 hover:bg-white/70 hover:text-gray-900 flex flex-row gap-2"><span>Resume</span></a>
      </nav>
    </div>
  );
}
